                ...
                <div class="panel-heading">
                 ...
                 <div class="panel-body">
                   <form method="POST" action="add-category-function.php">
                        ...
                        <input type="text" class="form-control" name="categoryName" required style="width:50%">
                        <label>Category Description</label>
                        <input type="text" class="form-control" name="categoryDescription" required style="width:50%">
